...
export function RegisterCourseForm({ userEmail }: RegisterCourseFormProps) {
  ...
  const [email, setEmail] = useState(userEmail); // Pre-fill with user's email
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (result.error) {
      ...
      router.push(`/admin/${result.organization.slug}`);
    }
  };
    ...
    <div className="mx-auto max-w-2xl px-4 py-8 sm:px-6">
      <div className="mb-8">
        ...
        <p className="mt-2 text-[#a8d4c0]">
          Set up your course to manage leagues, events, and players with Fore.
        </p>
      </div>
